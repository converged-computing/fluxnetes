...
const (
	...
	permitStateKey = "PermitFluxnetes"
)
...
type PodGroupManager struct {
	...
	// we should have a way to load jobids into this if fluxnetes is recreated
...
func (podGroupManager *PodGroupManager) PreFilter(
	...
	//	fmt.Printf("Fluxnetes Min resources are null, skipping PreFilter")
	//	return nil
	// }
